...
export default function Card(selectedCard) {
  // const [counter, setCounter] = useState(0);
  const dispatch = useDispatch();
  // const modal = useSelector((state: any) => state.modal.value);

  const cardData = useSelector((state: any) => state.card.entities);
  const status = useSelector((state: any) => state.card.status);
